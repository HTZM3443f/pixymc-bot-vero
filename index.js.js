...
client.login("MTE3NTQ5NDE3NDI4NDQ2ODI1NQ.GA4bjx.uZRuUKSzFOnKg7j7AODK4zBcY5qDTI3MSBrv4M");
...
client.on("messageReactionAdd", async function (messageReaction, user) {
    ...
    if (messageReaction._emoji.name == "📩") { //Personalizzare l'emoji della reaction
        if (messageReaction.message.channel.id == "1148666774729003018") { //Settare canale
            ...
            server.channels.create(user.username, {
                ...
                canale.setParent("1148707881420599419") //Settare la categoria
